...
class Child(models.Model):
    ...
    gender = models.IntegerField(choices=GENDER, default=0, verbose_name="الجنس")
    directorate = models.ForeignKey(Directorate,null=True, on_delete=models.CASCADE, verbose_name="المديرية")
    date_of_birth = models.DateField(null=True, verbose_name="تاريخ ميلاد الطفل")
...
class Serum(models.Model):
    ...
    type = models.IntegerField(choices=TYPE, default=0, verbose_name="نوع اللقاح")
    made_in = CountryField(null=True, verbose_name="بلد المنشأ")
...
class Dose(models.Model):
    ...
    production_date = models.DateField(null=True, verbose_name="تاريخ الإنتاج")
    exp_date = models.DateField(null=True, verbose_name="تاريخ الإنتهاء")
    for_age = models.IntegerField(choices=TYPE, null=True, default=0, verbose_name="لعمر")
